...
//=================Question 2================================
	...
	void TestQ2_withdraw(CuTest *tc) {
		...
		char actualFile[] =  "withdraw_test.txt";
		char goldenFile[] =  "withdraw.txt";
		int size;
		//create list using the input file
		student **Clist = create_class_list(inputFile,&size);
		input_grades(gradesFile,Clist,size);
		...
		output_final_course_grades("withdraw_test.txt",Clist,size);
...
//===========================================================
	CuSuite* Lab3GetSuite() {
		...
		SUITE_ADD_TEST(suite, TestQ1_two_empty);
